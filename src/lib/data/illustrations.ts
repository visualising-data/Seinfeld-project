...
export const illustrationEpisodes: { season: number; episode: number; filename: string }[] = [
  // Season 1
  { season: 1, episode: 1, filename: 'Seinfeld__0000_Season-1-_-Superman-T-Shirt.png' }, // The Stock Tip — Jerry's Superman t-shirt
  { season: 1, episode: 3, filename: 'Seinfeld__0001_Season-1-_-For-Sale-Ad.png' }, // The Robbery — Jerry considers moving, apartment ads
  { season: 1, episode: 4, filename: 'Seinfeld__0002_Season-1-_-Scrabble.png' }, // Male Unbonding — game night with Joel
  ...
  // Season 2
  { season: 2, episode: 2, filename: 'Seinfeld__0005_Season-2-_-Jerrys-Coat.png' }, // The Jacket — Jerry's suede jacket with pink stripes
  ...
  { season: 2, episode: 11, filename: 'Seinfeld__0008_Season-2-_-Bosco-Sauce.png' }, // The Chinese Restaurant — waiting, food obsession

  // Season 3
  { season: 3, episode: 14, filename: 'Seinfeld__0009_Season-3-_-The-PEZ-Dispenser.png' }, // The Pez Dispenser
  { season: 3, episode: 13, filename: "Seinfeld__0010_Season-3-_-O'Brien-Sign.png" }, // The Subway — underground signage
  ...
  { season: 3, episode: 21, filename: 'Seinfeld__0012_Season-3-_-Goldfish.png' }, // The Letter — the painting, Elaine and the fish
  ...
  // Season 5
  { season: 5, episode: 18, filename: 'Seinfeld__0017_Season-5-_-Trenchcoat.png' }, // The Raincoats — trenchcoats and Alton Benes
  ...
  { season: 6, episode: 13, filename: 'Seinfeld__0024_Season-6-_-Number-Plate.png' }, // The Scofflaw — special parking scofflaw plate

  // Season 7
  { season: 7, episode: 6, filename: 'Seinfeld__0025_Season-7-_-Coffee-Cup.png' }, // The Soup Nazi — no soup for you
  { season: 7, episode: 14, filename: 'Seinfeld__0026_Season-7-_-Yankees-Hat.png' }, // The Cadillac — George still with the Yankees
  ...
  { season: 8, episode: 13, filename: 'Seinfeld__0031_Season-8-_-Georges-Briefcase.png' }, // The Comeback — George's props and comeback line
  { season: 8, episode: 7, filename: 'Seinfeld__0032_Season-8-_-Dad-T-shirt.png' }, // The Checks — Japanese royalty checks and fan shirts
...
export function getIllustrationForEpisode(season: number, episode: number) {
  const entry = illustrationEpisodes.find((i) => i.season === season && i.episode === episode);
