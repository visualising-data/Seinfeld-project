<script>
  ...
  onMount(() => {
    ctx = gsap.context(() => {
      ...
      const scale2012 = scaleLinear()
        .domain([1989, 2012])
        .range([0, innerHeight - 240]);
      const scale2015 = scaleLinear()
        .domain([1989, 2015])
        .range([0, innerHeight - 240]);
      const scale2021 = scaleLinear()
        .domain([1989, 2021])
        .range([0, innerHeight - 240]);
      ...
      const H = innerHeight;
      const bottomY = /** @param {(year: number) => number} scale */ (
        /** @type {number} */ year,
        scale,
      ) => -(H - 120) + 60 + scale(year);
      ...
      tl1
        ...
        .to(
          ['#date-us', '#date-uk'],
          { translateY: 0, opacity: 1, ease: 'power3.out', duration: 2 },
          '-=2',
        );
      ...
      tl2
        ...
        .to(
          '#date-uk',
          { translateY: y1993(scale2012), opacity: 1, ease: 'power3.out', duration: 3 },
          '-=3',
        )
        .to(
          '#date-andy',
      ...
      tl3
        ...
        .to(
          '#date-uk',
          { translateY: y1993(scale2015), opacity: 1, ease: 'power3.out', duration: 3 },
          '-=3',
        )
        .to(
          '#date-andy',
      ...
      tl4
        ...
        .to(
          '#date-uk',
          { translateY: y1993(scale2021), opacity: 1, ease: 'power3.out', duration: 3 },
          '-=3',
        )
        .to(
          '#date-andy',
