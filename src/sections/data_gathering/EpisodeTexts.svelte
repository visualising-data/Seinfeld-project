...
>
	<div id="episode-example-text-1" class="text-overlay" use:inview={options} oninview_enter={() => episodeStepChange(1)}>
...
<div class="flex h-screen w-screen items-center justify-center">
	<div id="episode-example-text-2" class="text-overlay" use:inview={options} oninview_enter={() => episodeStepChange(2)}>
...
<!-- Text 3 -->
<div class="flex h-screen w-screen items-center justify-center">
	<div id="episode-example-text-3" class="text-overlay" use:inview={options} oninview_enter={() => episodeStepChange(3)}>
...
<!-- Text 4 -->
<div class="flex h-screen w-screen items-center justify-center">
	<div id="episode-example-text-4" class="text-overlay" use:inview={options} oninview_enter={() => episodeStepChange(4)}>
...
<!-- Text 5 -->
<div class="flex h-screen w-screen items-center justify-center">
	<div id="episode-example-text-5" class="text-overlay" use:inview={options} oninview_enter={() => episodeStepChange(5)}>
...
<!-- Text 6 -->
<div class="flex h-screen w-screen items-center justify-center">
	<div id="episode-example-text-6" class="text-overlay" use:inview={options} oninview_enter={() => episodeStepChange(6)}>
...
<!-- Text 7 -->
<div class="flex h-screen w-screen items-center justify-center">
	<div id="episode-example-text-7" class="text-overlay" use:inview={options} oninview_enter={() => episodeStepChange(7)}>
