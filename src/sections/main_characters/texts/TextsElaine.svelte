...
<div id="elaine-text-4" class="flex h-screen w-screen items-center justify-end md:pr-6">
  <div class="text-overlay" style="max-width: 800px;">
    ...
    share only <span class="highlight">rose gradually</span>, her laughter rates jumped from 13% in
    Season 1 to a peak of 24% by Season 8.
    <div class="small mt-4 mb-2">Average laughter share per season</div>
    <Sparkline
      charData={charData.ELAINE}
      showLabels={true}
      charId="GEORGE"
