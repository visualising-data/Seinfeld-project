...
<div id="kramer-text-1" class="flex h-screen w-screen items-center justify-end pr-6">
  <div class="text-overlay flex gap-4" style="max-width: 800px;">
    <div>
    ...
    <div class="shrink-0">
      <img loading="lazy" src="https://amdufour.github.io/hosted-data/apis/images/the_real_kramer.jpg" alt="The real Kramer" style="height: 215px;" />
